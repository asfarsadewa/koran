...
4. Pilih sebanyak-banyaknya delapan peristiwa yang berlainan dengan ukuran yang sama seperti edisi hari ini: dampak buruk nyata bagi manusia. Delapan ialah sasaran, bukan syarat. Sebagian pagi dalam sejarah memang tidak meninggalkan delapan peristiwa yang dapat dipertanggungjawabkan, dan pada pagi seperti itu terbitkan sebanyak yang sungguh ditopang keterangan — tujuh, empat, bahkan satu — lalu nyatakan kesempitan hari itu di dalam `mastheadDek`. Lembar yang tipis masih jujur; lembar yang tidak terbit tidak mengatakan apa pun kepada pembaca. Jangan sekali-kali menambal halaman dengan peristiwa yang tidak berdampak kemanusiaan, dengan calon yang buktinya tidak memadai, atau dengan karangan. Beri peringkat 1 sampai jumlah berita yang benar-benar dimuat, tanpa nomor yang terlewat, dan sertakan terjemahan Tionghoa untuk setiap peringkat itu. Buku calon menandai kesesuaian tanggal dengan empat sebutan: `exact` untuk hari cetak itu sendiri atau petang sebelumnya, `adjacent` untuk dua hari sebelumnya, tempat jendela redaksi masih mencapainya, `ongoing` untuk rentang bertanggal yang sudah berjalan lebih dahulu dan belum tutup pada pagi itu, dan `recent` untuk peristiwa bertanggal tunggal yang sudah lewat tetapi masih di dalam jangkauan. Utamakan menurut urutan itu. Perbedaan `ongoing` dan `recent` adalah perbedaan bukti, bukan perbedaan jarak hari: `ongoing` berarti catatannya sendiri menyebut rentang yang masih terbuka pada tanggal cetak, sedangkan `recent` berarti peristiwanya sudah terjadi dan tidak ada satu pun keterangan yang mengatakan ia masih berlangsung. Jangan menulis peristiwa `recent` seolah-olah ia masih berjalan pagi itu. Namun `recent` tetap sah dipilih, dan pada hari yang sepi ia justru menjadi sandaran utama: tulislah sebagai peristiwa yang telah terjadi beberapa hari sebelumnya, dengan kala dan keterangan waktu yang sesuai — “pada tanggal empat bulan ini”, bukan “hingga berita ini dihimpun”. Peristiwa yang bertanggal sesudah tanggal cetak tidak akan muncul di dalam buku calon sama sekali; jangan mencarinya kembali dengan alat lain. Jangan memasukkan kelahiran, kematian biasa, olahraga, hiburan, atau penemuan yang tidak menimbulkan korban.
...
6. Bedakan tiga perkara pada setiap calon sebelum memilihnya:
   ...
   - **Kaitan** — bukti yang `dikutip pada baris peristiwa` dipasang oleh penyunting tepat pada catatan hari itu, jadi ia terikat kepada peristiwanya. Bukti yang `dari daftar rujukan artikel` dipungut dari halaman pokoknya dan hanya disaring menurut tanggal: ia sezaman dengan pekan peristiwa, tetapi belum tentu berbicara tentang kejadian ini dan bukan kejadian lain di dalam perang yang sama. Periksa dahulu sebelum menyandarkan angka atau sebab kepadanya.
   - **Batas pengetahuan** — apakah bukti itu sudah ada di tangan meja redaksi pagi itu. Ruas ini terpisah dari waktu terbitnya dan ditandai `sudah terbit`, `terbit sesudahnya`, atau `waktu terbit tak tentu`. Kedua pertanyaan itu berlainan: kabar yang terbit sehari sesudah tanggal cetak tetap laporan sezaman, tetapi editor pagi itu belum memegangnya.
7. Utamakan calon yang mempunyai bukti `sezaman` dan sekurang-kurangnya satu penerbit yang berdiri sendiri di luar ensiklopedia. Di antara calon yang sepadan, dahulukan yang buktinya `sudah terbit` sebelum tanggal cetak. Artikel ensiklopedia sah menjadi tautan sumber, tetapi ia disusun lama sesudah peristiwanya; jangan memperlakukannya sebagai laporan sezaman. Bukti bertanda `kemudian` boleh menerangkan latar, tetapi tidak boleh menjadi satu-satunya penopang angka, sebab, atau tanggal. Bukti `sezaman` yang bertanda `terbit sesudahnya` menguatkan bahwa peristiwanya memang terjadi, tetapi tidak boleh memasukkan satu pun keterangan baru ke dalam naskah — angka, sebab, nama, maupun akibat — sebab keterangan itu belum ada pada pagi cetak. Dua tautan dari penerbit yang sama bukan dua sumber. Tautan boleh menuju artikel Wikipedia, Britannica, atau arsip berita HTTPS yang menunjuk langsung kepada peristiwa itu; jangan memakai halaman muka, pencarian, atau portal.
